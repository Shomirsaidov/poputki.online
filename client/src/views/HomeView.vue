  ...
  <div class="bg-slate-50 min-h-screen">
    ...
    <div class="p-5 space-y-4 pb-32">
      ...
      <template v-if="!isLoading && activeTab === 'rides'">
          ...
          <div v-for="(ride, index) in rides" :key="ride.id"
            ...
            <div class="flex justify-between items-start mb-4">
              ...
              <div class="bg-green-50 px-3 py-1.5 rounded-xl border border-green-100">
                <div class="text-lg font-bold text-green-600">{{ ride.price }} с.</div>
              </div>
            </div>
        ...
        <div v-if="rides.length === 0" class="text-center mt-16">
      ...
      <template v-if="!isLoading && activeTab === 'buses'">
            ...
            <div class="p-5">
              ...
              <div class="flex items-start justify-between mb-1">
                <div>
                  ...
                  <div class="text-sm text-slate-600 mt-1">{{ ticket.from_address }}</div>
                </div>
                ...
                <div class="text-right">
                  ...
                  <div class="text-sm text-slate-600 mt-1 max-w-[120px] text-right">{{ ticket.to_address }}</div>
                </div>
              </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <div class="text-xs text-gray-400 mt-0.5">{{ ticket.transport_company }}</div>
                </div>
                <div class="text-right">
        ...
        <div v-if="busTickets.length === 0" class="text-center mt-16">
